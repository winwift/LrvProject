                ...
                <div class="row g-0" style="justify-content: center">
                    <div class="col-lg-4 col-sm-6" >
                        ...
                        data-bs-description="Description Bedroom">
                            <img class="img-fluid pf-img" src="{{URL::to('/')}}/images/instalation.jpeg"alt="..." />
                    ...
                    <div class="col-lg-4 col-sm-6">
                        ...
                        data-bs-description="Bathroom installation">
                            ...
                            <img class="img-fluid pf-img" src="{{URL::to('/')}}/images/bathroom.jpeg" alt="..." />
                            <div class="portfolio-box-caption">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        ...
                        data-bs-description="Description Kitchen">
                            <img class="img-fluid pf-img"  src="{{URL::to('/')}}/images/kitchen.jpeg" alt="..." />
                            <div class="portfolio-box-caption">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        ...
                        data-bs-description="Description decoration">
                            ...
                            <img class="img-fluid pf-img" src="{{URL::to('/')}}/images/painting.jpeg" alt="..." />
                            <div class="portfolio-box-caption">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        ...
                        data-bs-description="Description Plumbing">
                            <img class="img-fluid pf-img"  src="{{URL::to('/')}}/images/plumbing.jpeg" alt="..." />
                            <div class="portfolio-box-caption">
